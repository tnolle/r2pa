...
def evaluate(name, dataset, ground_truth_process_model, process_discovery_result):
    ...
    evaluation_results['percentage of uncached cases only ground truth cases'] = \
    ...
    evaluation_results['process discovery time'] = process_discovery_result.process_discovery_time
    evaluation_results['cache generation time'] = process_discovery_result.cache_generation_time
    evaluation_results['case generation time'] = process_discovery_result.case_generation_time
    evaluation_results['cases to graph conversion time'] = process_discovery_result.cases_to_graph_conversion_time

    evaluation_results['dataset'] = dataset.dataset_name
    evaluation_results['next event predictor'] = process_discovery_result.next_event_predictor
    evaluation_results['use cache'] = process_discovery_result.use_cache
    evaluation_results['group attribute nodes'] = process_discovery_result.group_attribute_nodes
    evaluation_results['next event threshold'] = process_discovery_result.next_event_threshold
