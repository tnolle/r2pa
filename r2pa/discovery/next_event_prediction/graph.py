...
class GraphNextEventPredictor(NextEventPredictor):
        ...
        for i in range(number_attributes):
            ...
            for sequence in queue:
                ...
                for successor in successors:
                    ...
                    if likelihood < self.next_event_threshold:
                        continue
    ...
    def next_event_with_cache(self, input_case, input_case_length):
        return self.next_event(input_case, input_case_length)
