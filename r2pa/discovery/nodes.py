...
class NodeCreator:
    ...
    # TODO: change to create "unchanged" node
    ...
    def create_control_flow_node(self, event, index, attribute_sequence):
        ...
        # both cannot happen at the same time, TODO: split?
    ...
    def create_attribute_node(self, event, attribute, index, attribute_sequence, condition_node, control_flow_node):
        ...
        # TODO: set ungrouped identifier for this attribute node!
        # TODO: use control flow or condition node
        ...
        # TODO: use control flow node or condition node?
        if in_predecessor_grouped_nodes:
...
class Node:
    ...
    # TODO: group directly based on hash? would need all outgoing/ingoing paths..
    # TODO: add event sequence and store predecessor and successor slices?
...
class Edge:
    ...
    def __eq__(self, other):
        ...
        if not eq_destination:
            return False
        eq_value = self.value == other.value  # TODO: floating point?
        if not eq_value:
            return False
        return True
